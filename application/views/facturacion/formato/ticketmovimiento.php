...
<html>
	...
	<body onLoad="printThis();">
		...
		<table  width="280" border="0" align="center">
            ...
            <tr>
                <td align="left" class="InfoVer" colspan="3"> PROVEEDOR: <?php echo $venta[0]["razonsocial"];?> </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="Linea"><td colspan="5" align="center"> <?php echo $linea ?> </td></tr>
                        <tr>
                            <td width="10" align="center" class="Detallecab">CANT</td>
                            <td width="30" align="center" class="Detallecab">CODIGO</td>
                            <td width="210" align="center" class="Detallecab">PRODUCTO</td>
                        ...
                        <?php 
							foreach ($detalle as $key => $value) { ?>
								<tr>
									...
									<td align="left" class="Detalle"><?php echo $value["codigo"];?></td>
						...
						<tr class="Linea"><td colspan="5" align="center"> <?php echo $linea ?> </td></tr>
                        <tr>
                            <td colspan="4" align="right" class="Total">TOTAL S/:</td>
