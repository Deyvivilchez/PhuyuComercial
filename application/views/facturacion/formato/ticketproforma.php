...
<html>
	...
	<body onLoad="printThis();">
		...
		<table  width="280" border="0" align="center">
	        ...
	        <tr>
	            <td align="left" class="Cabecera2" colspan="2"> FECHA: <?php echo $venta[0]['fechaproforma'];?></td>
            ...
            <tr>
                <td align="left" class="InfoVer" colspan="3"> CLIENTE: <?php echo $venta[0]["razonsocial"];?> </td>
            </tr>
            <tr>
	        ...
	        <tr class="footer">
	            <td colspan="3" align="center"> <b>GRACIAS POR SU COTIZACION !</b> </td>
	        </tr>
	        <tr>
	            <td colspan="3">&nbsp;</td>
	        </tr>
