			...
			<div class="card-body">
				<div class="row form-group">
					...
					<div class="col-md-6" align="right">
						<button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal_vendedor"><i class="bi bi-layout-text-window"></i> X VENDEDORES</button>
						<button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal_clientes"><i class="bi bi-layout-text-window"></i> X CLIENTES</button>
				...
				<div class="row form-group">
					...
					<div class="col-md-2" style="margin-top: 1.2rem">
						<button type="button" class="btn btn-warning btn-icon" v-on:click="ver_consulta()"><i class="bi bi-search"></i> Consultar</button>
					</div>
				</div>
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body">
			    ...
			    <div class="row form-group">
			    	<div class="col-md-12">
			    		<div align="center">
							<button type="button" class="btn btn-danger btn-sm" v-on:click="pdf_pedidos_vendedor_resumen()" style="margin-bottom: 1rem"><i class="bi bi-printer"></i> Reporte general PDF</button>
				...
				<div class="row form-group">
					<div class="col-md-12">
						<div align="center">
							<button type="button" class="btn btn-success btn-sm" v-on:click="excel_pedidos_vendedor_resumen()"><i class="bi bi-file-earmark-excel"></i> Reporte general EXCEL</button>
							<button type="button" class="btn btn-success btn-sm" v-on:click="excel_pedidos_vendedor()"><i class="bi bi-file-earmark-excel"></i> Reporte detallado EXCEL</button>
						</div>
			    	</div>
			    </div>
			  </div>
