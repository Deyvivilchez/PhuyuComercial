...
header('Content-Disposition: attachment;filename="REPORTECOMPRASXPROVEEDOR' . date('Y-m-d') . '.xls"');
...
<table border="1">
    <tr>
        <th colspan="13"> 
            <b>REPORTE DE COMPRAS POR PROVEEDOR <?php echo utf8_decode($_SESSION["phuyu_empresa"]);?></b>
        </th>
    </tr>
    <tr>
        <th colspan="13">
    ...
    <?php 
        ...
        foreach ($personas as $key => $value){ ?>  
            <tr>
                <th colspan="12"> <b>PROVEEDOR: <?php echo utf8_decode($value["razonsocial"]);?></b> </th>
            </tr>                  
            <tr>
