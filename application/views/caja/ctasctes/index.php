<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion Cuentas Corrientes</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Cuentas Corrientes</a></li>
              </ul>
            </nav>
        </div>
    </div>
						...
						<table class="table table-striped" style="font-size: 11px">
							...
							<tbody>
								<tr v-for="dato in datos" v-bind:class="[dato.estado==0 ? 'phuyu_anulado':'']">
									<td>{{dato.codctacte}}</td>
									<td>{{dato.socio}}</td>
									<td>{{dato.banco}}</td>
									<td>{{dato.nroctacte}}</td>
									<td>{{dato.descripcion}}</td>
									<td> <input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codctacte)"> </td>
								</tr>
							</tbody>
						</table>
					</div>
