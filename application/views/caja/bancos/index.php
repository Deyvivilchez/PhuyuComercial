<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion de Bancos</h1>
					...
					<table class="table table-striped" style="font-size: 11px">
						...
						<tbody>
							<tr v-for="(dato,index) in datos">
								...
								<td> <input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codbanco)"> </td>
							</tr>
						</tbody>
					</table>
				</div>
