...
<div class="row g-3 phuyu-velzon-form" id="phuyu_form_1">
	<div class="col-md-7 col-12 border-end">
		...
		<form id="formulario" class="form-horizontal" v-on:submit.prevent="phuyu_guardar_1('almacen/marcas')">
			...
			<div class="mb-3">
				<label class="form-label fw-bold text-uppercase">Descripción marca</label>
				<input type="text" name="descripcion_extencion" v-model.trim="agregar.descripcion" class="form-control" required autocomplete="off" placeholder="Descripción" maxlength="100">
			</div>
