<div id="phuyu_datos">
    <div class="row">
        <div class="col-12 col-md-6">
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion Empleados</h1>
        ...
        <div class="card">   
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-5 col-xxl-10 text-end mb-1" align="right">
                            ...
                            <table class="table table-striped" style="font-size: 11px">
                                ...
                                <tbody>
                                    <tr v-for="dato in datos">
                                        ...
                                        <td>{{dato.area}}</td>
                                        <td>{{dato.sueldo}}</td>
                                        <td><input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codpersona)"> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
