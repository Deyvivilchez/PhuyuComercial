<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion de Rubros</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Rubros</a></li>
              </ul>
            </nav>
        </div>
	</div>
					...
					<table class="table table-striped" style="font-size: 11px">
						<thead>
							<tr>
								...
								<th style="width: 95%">DESCRIPCION RUBRO</th>
								<th width="5%"></th>
							</tr>
						</thead>
						<tbody>
							<tr v-for="(dato,index) in datos">
								...
								<td> <input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codrubro)"> </td>
							</tr>
						</tbody>
					</table>
				</div>
