<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion Sucursales</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Sucursales</a></li>
              </ul>
            </nav>
        </div>
	</div>
				...
				<div class="row">
		            ...
		            <div class="col-sm-12 col-md-7 col-lg-7 col-xxl-10 text-end mb-1" align="right">
		                <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
		                  ...
		                  <button type="button" class="btn btn-warning btn-icon" v-on:click="phuyu_asignarlineas()"> <i data-acorn-icon="plus"></i> ASIGNAR LINEAS </button>
		                  <!-- Delete Button End -->
		                </div>
		            </div>
			    </div>
