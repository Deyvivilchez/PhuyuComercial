...
<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion Clientes</h1>
			...
			<div class="card-body">
				...
				<div class="data-table-responsive-wrapper">
					<table class="table table-striped" style="font-size: 11px">
						...
						<tbody>
							<tr v-for="(dato,index) in datos" class="rows_table" style="cursor: pointer;"  v-on:click="marcar(index,dato.codpersona)">
								...
								<td>{{dato.email}}</td>
								<td> 
									<input type="radio" class=" form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codcliente,dato.estado)"> 
								</td>
							</tr>
						</tbody>
					</table>
