	...
	<form id="formulario" class="form-horizontal" v-on:submit.prevent="phuyu_guardar()">
	    ...
	    <div class="row form-group">
		    ...
		    <div class="col-md-2 col-xs-12" style="padding-top:15px;">
		    	<button type="button" class="btn btn-success btn-icon btn-consultar" v-on:click="phuyu_consultar();"> <i data-acorn-icon="search"></i> </button>
		    </div>
	    </div>
	    <div class="row form-group">
	    	<div class="col-xs-12">
...
<script> var campos = {codregistro:"",codsociotipo: "1",coddocumentotipo: "",documento: "",razonsocial: "",nombrecomercial:"",direccion: "",email: "",telefono: "",departamento: "",provincia: "",codubigeo: "",codpatrocinador:0}; 
