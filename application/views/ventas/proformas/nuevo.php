			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row form-group">
						<div class="col-md-4 col-xs-12"> <h5 class=" text-danger"><b>PROFORMA N° {{campos.nro}}</b></h5> </div>
					</div>
					<div class="row form-group">
					...
					<div class="row form-group">
						...
						<div class="col-md-7" align="right">
							<button type="button" class="btn btn-warning btn-icon" v-on:click="phuyu_venta()"> 
								<b> <i data-acorn-icon="plus"></i> NUEVA PROFORMA</b> 
							</button>
							<button type="submit" class="btn btn-info btn-icon" v-bind:disabled="estado==1"> 
								<b><i data-acorn-icon="arrow-right"></i> CONTINUAR PROFORMA</b> 
							</button>
				...
				<div class="modal-body">
			    	...
			    	<div class="text-center">
						...
						<button type="button" class="btn btn-success" v-on:click="phuyu_itemcalcular_cerrar(item)">
							<i class="fa fa-save"></i> GUARDAR PROFORMA
						</button>
					</div>
				</div>
			</div>
