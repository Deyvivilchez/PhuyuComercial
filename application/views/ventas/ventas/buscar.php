<div id="phuyu_buscar">
	<div style="padding:10px 0px; height:53px; border-bottom: 2px solid #f3f3f3;">
		<div class="col-md-12 col-xs-10">
			<input type="text" class="form-control" v-model="buscar" v-on:keyup="phuyu_buscar()" placeholder="BUSCAR VENTA . . ." v-bind:autofocus="true">
		</div>
	</div>
	...
	var phuyu_buscar = new Vue({
		...
		methods: {
			phuyu_ventas: function(){
				...
				this.cargando = true;
				this.$http.post(url+"ventas/ventas/buscar_lista",{"buscar":this.buscar,"pagina":this.paginacion.actual}).then(function(data){
