		...
		<div class="phuyu_body">
			<div class="card">
				...
				<div class="card-body">
							...
							<table class="table table-striped" style="font-size: 11px">
								...
								<tbody>
									<tr v-for="(dato,index) in detalle">
										...
										<td>
											<input type="number" step="0.0001" class="form-control number" v-model.number="dato.cantidad" v-on:keyup="phuyu_calcular(dato,3)" required>
										</td>
										<td>
					...
					<div class="row">
						<div class="col-md-5">
							<button type="button" class="btn btn-success btn-icon " v-on:click="phuyu_searchpedido()"><i data-acorn-icon="search"></i> BUSCAR PEDIDO</button>
							<button type="button" class="btn btn-primary btn-icon" v-on:click="phuyu_searchproforma()"><i data-acorn-icon="search"></i> BUSCAR PROFORMA</button>
						</div>
						<div class="col-md-7" align="right">
							<button type="button" class="btn btn-warning btn-icon" v-on:click="phuyu_venta()"> 
								<b> <i data-acorn-icon="plus"></i> NUEVA VENTA</b> 
							</button>
							<button type="submit" class="btn btn-info btn-icon" v-bind:disabled="estado==1" data-bs-target="#modal_finventa"> 
