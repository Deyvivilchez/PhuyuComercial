...
<div id="phuyu_operacion">
	...
	<form id="formulario" class="form-horizontal" v-on:submit.prevent="phuyu_guardar()">
		...
		<div class="phuyu_body">
			<div class="card">
				...
				<div class="card-body">
					<div class="row mb-2">
						<h4 class="text-danger"><b>EDITAR PEDIDO N° {{campos.nro}}</b></h4>
					</div>
					<div class="row mb-2">
							...
							<table class="table table-striped" style="font-size: 11px">
								...
								<tbody>
									<tr v-for="(dato,index) in detalle">
										...
										<td v-if="dato.codafectacionigv!=21">
											<input type="number" step="0.01" class="form-control number"  v-model.number="dato.subtotal" v-if="dato.calcular==0" readonly>
				...
				<div class="modal-body">
			    	...
			    	<div class="text-center">
						...
						<button type="button" class="btn btn-success" v-on:click="phuyu_pagar()">
							<i class="fa fa-save"></i> GUARDAR EDICION
						</button>
					</div>
				</div>
			</div>
	...
	<div id="modal_itemdetalle" data-bs-backdrop="static" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header modal-phuyu-titulo">
					<h4 class="modal-title"> <b>DETALLE DEL ITEM DE LA VENTA</b> </h4> 
				</div>
				<div class="modal-body">
					<h5> <b>
