<div id="phuyu_form">
	<div style="padding: 0px 20px;">
		<div class="row">
			<div class="col-md-7">
				<h6><b>PEDIDO:</b> 000<?php echo $info[0]["codpedido"];?> | <b>FECHA PEDIDO:</b> <?php echo $info[0]["fechapedido"];?> </h6>
			...
			<div class="col-md-5">
				...
				<h6><b>VENDEDOR: </b> <?php echo $info[0]["vendedor"];?></h6>
			</div>
		</div>
		...
		<h4 align="center">
			<span class="alert alert-danger">DESC.: S/. <?php echo number_format(round($info[0]["descglobal"],2) ,2);?> </span> &nbsp;
			<span class="alert alert-primary">VALOR VENTA: S/. <?php echo number_format(round($info[0]["valorventa"],2) ,2);?> </span> &nbsp;
			<span class="alert alert-warning">I.G.V: S/. <?php echo number_format(round($info[0]["igv"],2) ,2);?> </span>
		</h4><br>
