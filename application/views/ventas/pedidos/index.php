<div id="phuyu_pedidos">
	<div class="row">
		<div class="col-12 col-md-6">
            ...
            <h1 class="mb-0 pb-0 display-4" id="title">Administracion de Pedidos</h1>
					...
					<table class="table table-striped" style="font-size: 11px">
						<thead>
							<tr> </center> </th>
								...
								<th>PAGO</th>
								<th>ESTADO</th>
								<th width="5px;"> <center> <i class="fa fa-circle-o"></i>
							</tr>
						</thead>
						<tbody>
							<tr v-for="dato in datos" v-bind:class="[dato.estado==0 ? 'phuyu_anulado':'']">
								...
								<td> 
									<input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codpedido,dato.estado)"> 
								</td>
							</tr>
						</tbody>
					</table>
