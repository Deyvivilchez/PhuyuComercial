    ...
    <div class="card phuyu-detail-card">
        <div class="card-body">
            ...
            <div class="phuyu-detail-header">
                ...
                <div>
                    <p class="text-muted text-uppercase mb-1">Detalle del ingreso</p>
                    <h5 class="mb-0">NROINGRESO: 000<?php echo $info[0]["codkardex"];?></h5>
                </div>
                <span class="badge bg-success ms-auto">Fecha: <?php echo $info[0]["fechakardex"];?></span>
            </div>
            ...
            <div class="phuyu-total">
                TOTAL INGRESO: <?php echo $simbolo." ".number_format(round($info[0]["importe"],2) ,2);?>
            </div>
        </div>
    </div>
</div>
