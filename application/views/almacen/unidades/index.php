...
<div id="phuyu_datos" class="phuyu-almacen-list">
	<div class="phuyu-page-title">
		<div class="phuyu-page-icon"><i class="bi bi-rulers"></i></div>
		<div>
			<div class="text-muted small text-uppercase fw-semibold">Almacen</div>
			<h4 class="mb-0 fw-bold">Administracion de unidades</h4>
		</div>
	</div>
					...
					<table class="table table-hover align-middle mb-0">
						...
						<tbody>
							<tr v-for="(dato,index) in datos">
								<td class="text-muted fw-semibold">{{dato.codunidad}}</td>
								<td class="fw-semibold">{{dato.descripcion}}</td>
								<td><span class="badge bg-primary-subtle text-primary">{{dato.oficial}}</span></td>
								<td class="text-center">
									<input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codunidad)">
								</td>
							</tr>
