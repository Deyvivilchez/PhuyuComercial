<style>
    #phuyu_salidas.phuyu-almacen-list .page-title-box {
        margin-bottom: 18px;
    }
    #phuyu_salidas.phuyu-almacen-list .page-title-box h4 {
        color: #212529;
        font-weight: 700;
        margin-bottom: 4px;
    }
    #phuyu_salidas.phuyu-almacen-list .breadcrumb {
        margin-bottom: 0;
    }
    #phuyu_salidas.phuyu-almacen-list .phuyu-filter-panel {
        background: #fff;
    ...
    #phuyu_salidas.phuyu-almacen-list label {
        color: #495057;
        font-size: 12px;
        font-weight: 700;
        margin-bottom: 6px;
    ...
    #phuyu_salidas.phuyu-almacen-list .form-control,
    #phuyu_salidas.phuyu-almacen-list .form-select {
        border: 1px solid #d9e2ef;
        border-radius: 6px;
        box-shadow: none;
        min-height: 38px;
    }
    #phuyu_salidas.phuyu-almacen-list .phuyu-list-card {
        border: 1px solid #e9ebec;
        border-radius: 8px;
        box-shadow: 0 1px 2px rgba(56, 65, 74, 0.08);
    }
    #phuyu_salidas.phuyu-almacen-list .phuyu-toolbar {
        align-items: center;
        gap: 8px;
    }
    #phuyu_salidas.phuyu-almacen-list .phuyu-toolbar .btn-icon {
        align-items: center;
        display: inline-flex;
        height: 38px;
    ...
    #phuyu_salidas.phuyu-almacen-list .phuyu-data-table {
        font-size: 12px;
    }
    #phuyu_salidas.phuyu-almacen-list .phuyu-data-table thead th {
        background: #f3f6f9;
        color: #495057;
        font-size: 11px;
        letter-spacing: .2px;
    ...
    #phuyu_salidas.phuyu-almacen-list .modal-content {
        border: 0;
        border-radius: 8px;
        box-shadow: 0 10px 30px rgba(15, 23, 42, 0.14);
    }
    #phuyu_salidas.phuyu-almacen-list .modal-header {
        align-items: center;
        background: #f3f6f9;
				...
				<div class="row g-2 phuyu-toolbar mb-3">
					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xxl-10 text-end mb-1">
						<div class="d-flex flex-wrap justify-content-end phuyu-toolbar">
							<button type="button" class="btn btn-success btn-icon" title="Nueva Salida" v-on:click="phuyu_nuevo()"> <i class="bi bi-plus-lg"></i></button>
							<button type="button" class="btn btn-info btn-icon" title="VER SALIDA" v-on:click="phuyu_ver()"> <i class="bi bi-eye"></i> </button>
						    <button type="button" class="btn btn-warning editar btn-icon" title="EDITAR SALIDA" v-on:click="phuyu_editar()"> <i class="bi bi-pencil-square"></i> </button>
						    <button type="button" class="btn btn-danger btn-icon btn-outline-icon eliminar" title="ELIMINAR SALIDA" v-on:click="phuyu_eliminar()"> <i class="bi bi-trash"></i> </button>
						    <button type="button" class="btn btn-primary btn-icon" title="IMPRIMIR SALIDA" v-on:click="phuyu_imprimir()"> <i class="bi bi-printer"></i></button>
						    <button type="button" class="btn btn-info btn-icon" title="CLONAR SALIDA" v-on:click="phuyu_clonar()"> <i class="bi bi-files"></i> </button>
						    <button type="button" class="btn btn-success guia" v-on:click="phuyu_asignarguia()"> <i class="bi bi-truck me-1"></i> Asignar Guía </button>
					    </div>
					</div>
				</div>
