...
<div id="phuyu_datos" class="phuyu-prestamos-list">
	<div class="row page-title-box">
		<div class="col-12">
            ...
            <h4 id="title">Administración Prestamos x Devolver</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                    <li class="breadcrumb-item active">Prestamos x Devolver</li>
                </ol>
            </nav>
        </div>
    </div>
				...
				<div class="row g-2 phuyu-toolbar mb-3">
	                ...
	                <div class="col-sm-12 col-md-6 col-lg-6 col-xxl-10 text-end mb-1">
	                    <div class="d-flex flex-wrap justify-content-end phuyu-toolbar">
							...
							<button type="button" class="btn btn-info" v-on:click="phuyu_operacion(7)"> <i class="bi bi-arrow-left-right me-1"></i> Devolver prestamos </button>
		                </div>
	                </div>
			    </div>
