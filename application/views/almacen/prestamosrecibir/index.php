<style>
    #phuyu_datos.phuyu-prestamos-list .page-title-box {
        margin-bottom: 18px;
    }
    #phuyu_datos.phuyu-prestamos-list .page-title-box h4 {
        color: #212529;
        font-weight: 700;
        margin-bottom: 4px;
    }
    #phuyu_datos.phuyu-prestamos-list .breadcrumb {
        margin-bottom: 0;
    }
    #phuyu_datos.phuyu-prestamos-list .phuyu-list-card {
        border: 1px solid #e9ebec;
        border-radius: 8px;
        box-shadow: 0 1px 2px rgba(56, 65, 74, 0.08);
    }
    #phuyu_datos.phuyu-prestamos-list .phuyu-toolbar {
        align-items: center;
        gap: 8px;
    }
    #phuyu_datos.phuyu-prestamos-list .form-control,
    #phuyu_datos.phuyu-prestamos-list .form-select {
        border: 1px solid #d9e2ef;
        border-radius: 6px;
        box-shadow: none;
        min-height: 38px;
    }
    #phuyu_datos.phuyu-prestamos-list label {
        color: #495057;
        font-size: 12px;
        font-weight: 700;
        margin-bottom: 6px;
    ...
    #phuyu_datos.phuyu-prestamos-list .phuyu-data-table {
        font-size: 12px;
    }
    #phuyu_datos.phuyu-prestamos-list .phuyu-data-table thead th {
        background: #f3f6f9;
        color: #495057;
        font-size: 11px;
        letter-spacing: .2px;
    ...
    #phuyu_datos.phuyu-prestamos-list .modal-content {
        border: 0;
        border-radius: 8px;
        box-shadow: 0 10px 30px rgba(15, 23, 42, 0.14);
    }
    #phuyu_datos.phuyu-prestamos-list .modal-header {
        background: #f3f6f9;
        border-bottom: 1px solid #e9ebec;
    }
</style>

<div id="phuyu_datos" class="phuyu-prestamos-list">
	<div class="row page-title-box">
		<div class="col-12">
			<input type="hidden" id="formato" value="<?php echo $_SESSION['phuyu_formato'];?>">
            <h4 id="title">Administración Prestamos Otorgados x recibir</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                    <li class="breadcrumb-item active">Prestamos Otorgados x recibir</li>
                </ol>
            </nav>
        </div>
    </div>
				...
				<div class="row g-2 phuyu-toolbar mb-3">
	                ...
	                <div class="col-sm-12 col-md-6 col-lg-6 col-xxl-10 text-end mb-1">
	                    <div class="d-flex flex-wrap justify-content-end phuyu-toolbar">
							<button type="button" class="btn btn-warning" v-on:click="phuyu_historial()"> <i class="bi bi-file-earmark-text me-1"></i> Historial </button>
							<button type="button" class="btn btn-info" v-on:click="phuyu_operacion(25)"> <i class="bi bi-arrow-left-right me-1"></i> Recibir prestamos otorgados</button>
		                </div>
	                </div>
			    </div>
						...
						<table class="table table-hover align-middle mb-0 phuyu-data-table">
							...
							<tbody>
								<tr v-for="dato in datos">
									...
									<td>
										<span class="badge bg-warning text-dark" v-if="dato.cantidaddevuelta!=0">PENDIENTE</span>
										<span class="badge bg-success" v-else="dato.cantidaddevuelta==dato.cantidad">DEVUELTO</span>
									</td>
