<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            ...
            <h1 class="mb-0 pb-0 display-4" id="title">Administración de Despachos Venta</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Despachos Venta</a></li>
              </ul>
            </nav>
        </div>
    </div>
				...
				<div class="row">
	                ...
	                <div class="col-sm-12 col-md-6 col-lg-6 col-xxl-10 text-end mb-1">
	                    <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
				    		<button type="button" class="btn btn-info btn-icon" v-on:click="phuyu_operacion(20)"> <i data-acorn-icon="exchange"></i> DESPACHAR VENTA </button>
		                </div>
	                </div>
			    </div>
