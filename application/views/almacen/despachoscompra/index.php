<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            ...
            <h1 class="mb-0 pb-0 display-4" id="title">Administración de Despachos Compra</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Despachos Compra</a></li>
              </ul>
            </nav>
        </div>
    </div>
				...
				<div class="row">
	                ...
	                <div class="col-sm-12 col-md-6 col-lg-6 col-xxl-10 text-end mb-1">
	                    <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
						    <button type="button" class="btn btn-primary btn-icon" v-on:click="phuyu_operacion(2)"> <i data-acorn-icon="exchange"></i> RECIBIR COMPRA </button>
		                </div>
	                </div>
			    </div>
						...
						<table class="table table-striped" style="font-size: 11px">
							...
							<tbody>
								<tr v-for="dato in datos">
									...
									<td>
										<span class="alert alert-warning" v-if="dato.retirar==0">PENDIENTE</span>
										<span class="alert alert-success" v-else="dato.retirar==1">DESPACHADO</span>
									</td>
