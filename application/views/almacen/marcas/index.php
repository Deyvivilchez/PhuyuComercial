...
<div id="phuyu_datos" class="phuyu-almacen-list">
	<div class="phuyu-page-title">
		...
		<div>
			...
			<h4 class="mb-0 fw-bold">Administracion de marcas</h4>
		</div>
	</div>
					...
					<table class="table table-hover align-middle mb-0">
						...
						<tbody>
							<tr v-for="(dato,index) in datos">
								<td class="text-muted fw-semibold">{{dato.codmarca}}</td>
								<td class="fw-semibold">{{dato.descripcion}}</td>
								<td class="text-center">
									<input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codmarca)">
								</td>
							</tr>
