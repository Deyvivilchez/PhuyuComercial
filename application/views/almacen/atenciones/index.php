...
<div id="phuyu_datos" class="phuyu-almacen-list">
	<div class="phuyu-page-title">
		<div class="phuyu-page-icon"><i class="bi bi-printer"></i></div>
		<div>
			<div class="text-muted small text-uppercase fw-semibold">Almacen</div>
			<h4 class="mb-0 fw-bold">Areas de atencion producto</h4>
		</div>
	</div>
						...
						<table class="table table-hover align-middle mb-0">
							<thead>
								<tr>
									...
									<th>Impresora</th>
									<th width="110">Copias</th>
								</tr>
							</thead>
							<tbody>
								<tr v-for="dato in datos">
									<td class="text-center">
										<input type="radio" class="form-check-input" name="phuyu_seleccionar" v-on:click="phuyu_seleccionar(dato.codatencion)">
									</td>
									<td class="fw-semibold">{{dato.descripcion}}</td>
									<td>{{dato.impresora}}</td>
									<td><span class="badge bg-primary-subtle text-primary">{{dato.copias}}</span></td>
								</tr>
