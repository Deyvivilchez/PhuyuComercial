		...
		<div class="phuyu_body">
			<div class="card">
				<div class="card-header" style="padding:1rem 2rem 1rem !important">
					<div class="row">
						<div class="col-md-4 col-xs-12"> <h5>REGISTRAR NUEVA PROFORMA</h5> </div>
					</div>
				</div>
				<div class="card-body">
					<div class="row mb-2">
						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<tr v-for="(dato,index) in detalle">
									...
									<td>
										<input type="number" step="0.000001" class="phuyu-input number" v-if="dato.codafectacionigv==21" v-model.number="dato.preciosinigv" min="0" readonly>
										<input type="number" step="0.000001" class="phuyu-input number" v-if="dato.codafectacionigv!=21" v-model.number="dato.preciosinigv" v-on:keyup="phuyu_calcular(dato)" min="0.0001" required  v-bind:disabled="dato.porcdescuento==100" >
									</td>
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<button type="submit" class="btn btn-success btn-block" v-bind:disabled="estado==1"> 
									<b><i class="fa fa-save"></i> GUARDAR PROFORMA</b> 
								</button>
							</div>
							<div class="col-md-4 col-xs-12">
...
<script src="<?php echo base_url();?>phuyu/phuyu_proformas/compraproforma.js"> </script>
