		...
		<div class="phuyu_body">
			<div class="card">
				<div class="card-header" style="padding:1rem 2rem 1rem !important">
					<div class="row">
						<div class="col-md-4 col-xs-12"> <h5>EDITAR PEDIDO</h5> </div>
					</div>
				</div>
				<?php 
					$disabled = '';
				...
				<div class="card-body">
					<div class="row mb-2">
				    	<div class="col-md-3 col-xs-12">
					    	<label>TIPO COMPROBANTE REFERENCIA</label>
					    	<select class="form-control" name="codcomprobantetiporeferencia" v-model="campos.codcomprobantetiporeferencia" required v-on:change="phuyu_series_referencia()">
					    		<?php
					    ...
					    <div class="col-md-2 col-xs-12">
					    	<label>SERIE REF. <b>(NRO: {{campos.nroreferencia}})</b></label>
				        	<select class="form-control" id="seriecomprobantereferencia" v-model="campos.seriecomprobantereferencia" v-on:change="phuyu_correlativo_referencia()" required>
					    		<option value="">SERIE REFERENCIA</option>
					    		<option v-for="dato in seriesreferencia" v-bind:value="dato.seriecomprobante"> 
					...
					<div class="row mb-2">
						...
						<div class="col-md-4 col-xs-10" style="display: none">
						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<tr v-for="(dato,index) in detalle">
									...
									<td>
										<input type="number" step="0.0001" class="phuyu-input number" v-model.number="dato.cantidad" v-on:keyup="phuyu_calcular(dato)" min="0.0001" required>
									</td>
									<td>
									...
									<td v-if="dato.codafectacionigv!=21">
										<input type="number" step="0.01" class="phuyu-input number"  v-model.number="dato.subtotal" v-if="dato.calcular==0" readonly>
					...
					<div class="row">
						<div class="col-md-4 col-xs-6">
							<button type="button" class="btn btn-warning btn-block" v-on:click="phuyu_venta()" disabled> 
