...
.mesa-tile{
  ...
  padding: 1.2rem .6rem .6rem .6rem !important;  /* +espacio arriba para el badge */
...
.mesa-tile h6{ color:#6b7280 !important; }
.mesa-tile h3{ color:#111827 !important; }
						...
						<div class="mesas-box">
							...
							<div class="mesas-header">
								...
								<div class="mesas-toolbar">
									<select class="form-select input-sm" v-model="campos.codambiente" v-on:change="phuyu_mesas()" id="codambiente">
									...
									<div class="mesas-grid">
										<div class="phuyu-mesas" v-for="dato in mesas" v-on:click="phuyu_pedido(dato)">
											<div class="mesa-tile" v-bind:class="dato.color" v-bind:id="dato.codmesa">
												...
												<h6>Mesa</h6>
												<h3>{{ dato.nromesa }}</h3>
												<h6 class="hint"><i class="fa fa-info-circle"></i> {{ dato.texto }}</h6>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-4">
									<div class="d-grid">
										...
										<button type="button" class="btn btn-info btn-block btn-sm mb-2 " v-on:click="phuyu_avance_pedido()">
											<i class="fa fa-money"></i> IMPRIMIR PRE-CUENTA
										</button>
										<button type="button" class="btn btn-warning btn-block mb-2  btn-sm" v-on:click="phuyu_comanda()">
