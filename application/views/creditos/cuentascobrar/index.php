<div id="phuyu_creditos">
	<div class="row">
		<div class="col-12 col-md-6">
            ...
            <h1 class="mb-0 pb-0 display-4" id="title"><span class="badge bg-danger" v-if="sessioncaja==0">La Caja no esta Aperturada</span> Cuentas por Cobrar</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Cuentas por Cobrar</a></li>
              </ul>
            </nav>
        </div>
    </div>
	                ...
	                <div class="col-sm-12 col-md-7 col-lg-8  col-xxl-10 text-end mb-1">
			    		<div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
						    ...
						    <button type="button" class="btn btn-info btn-icon btn-icon-end" v-on:click="phuyu_cobranza()">
						        <i data-acorn-icon="money"></i> COBRANZA 
						    </button>
						    ...
						    <button type="button" class="btn btn-success btn-icon btn-icon-end" v-on:click="phuyu_persona()"> <i data-acorn-icon="plus"></i> NUEVO CLIENTE</button>
						</div>
				    </div>
				</div>
