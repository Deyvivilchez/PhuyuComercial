			...
			<div class="card-body">
				<div class="phuyu-toolbar">
					<div class="phuyu-search">
						...
						<input class="form-control datatable-search" v-model="buscar" v-on:keyup="phuyu_buscar()" placeholder="Buscar cuenta por pagar">
					</div>
					...
					<div class="phuyu-actions">
						...
						<button type="button" class="btn btn-success" v-on:click="phuyu_persona()">
							<i class="bi bi-person-plus me-1"></i> Nuevo proveedor
						</button>
					</div>
				</div>
						...
						<tbody>
							...
							<tr v-if="datos.length==0">
								<td colspan="7" class="text-center text-muted py-4">
									<i class="bi bi-inbox me-1"></i> Sin cuentas por pagar
								</td>
							</tr>
						</tbody>
					</table>
