				...
				<div class="card-body">
						...
						<div class="col-md-12 col-xs-12">
							...
							<div class="cobros" style="height:200px;">
								<table class="table table-bordered" style="font-size: 11px">
									...
									<tfoot>
										<tr>
											<td colspan="4" style="font-size: 14px;text-align: right;"><b>Total a Pagar</b></td>
				    ...
				    <div class="row form-group">
						<div class="col-md-12" align="right">
							<button type="submit" class="btn btn-primary btn-icon" v-bind:disabled="estado==1"> <b>GUARDAR PAGO</b> </button>
...
<script src="<?php echo base_url();?>phuyu/phuyu_creditos/pagar.js"> </script>
<script>
