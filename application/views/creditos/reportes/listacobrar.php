<div id="phuyu_datos">
	<div class="row">
		<div class="col-12 col-md-6">
            ...
            <h1 class="mb-0 pb-0 display-4" id="title">Créditos por Cobrar</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
              <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
                <li class="breadcrumb-item"><a href="javascript:;">Credito por Cobrar</a></li>
              </ul>
            </nav>
        </div>
				...
				<div class="row">
			    	<div class="col-md-2 ">
			    		<button type="button" class="btn btn-icon btn-icon-end btn-warning" v-on:click="phuyu_editar('CLIENTE')">
					        <i data-acorn-icon="edit"></i> Cambiar Cliente
					    </button>
					</div>
					<div class="col-md-2">
					    <div class="dropdown">
						...
						<table class="table table-striped" style="font-size: 11px">
							...
							<tbody>
								<tr v-for="dato in datos">
									...
									<td>{{dato.saldo}} </td>
									<td>
										<h5 v-if="dato.estado==0"><span class="badge bg-danger">ANULADO</span></h5>
										<h5 v-if="dato.estado==1"><span class="badge bg-warning">PENDIENTE</span></h5>
										<h5 v-if="dato.estado==2"><span class="badge bg-success">CANCELADO</span></h5>
									</td>
