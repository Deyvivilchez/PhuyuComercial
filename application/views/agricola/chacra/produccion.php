			...
			<div class="card">
				<div class="card-body">
		        	...
		        	<div class="row mb-2">
					    ...
					    <div class="col-md-1 col-xs-6">
					    	<label>SERIE</label>
					    	<input type="text" class="form-select" name="seriecomprobante" v-model="campos.seriecomprobante" readonly>
				    ...
				    <div class="row mb-2">
				    	...
				    	<div class="col-md-5 col-xs-12">
					    	<label>DESCRIPCION DE LA PRODUCCION</label>
						...
						<table class="table table-striped" style="font-size: 11px">
							<thead>
								<tr >
									...
									<th width="5%">STOCK ACTUAL</th>
									<th width="8%">CANTIDAD</th>
									<th width="8%">DESC. CANT (%)</th>
									<th width="8%">CANTIDAD FINAL</th>
							...
							<tbody>
								<tr v-for="(dato,index) in detalle">
									...
									<td>
										<input type="number" step="0.0001" class="form-control number" v-model.number="dato.cantidadbruta" v-on:keyup="phuyu_calcular(dato,3)" min="0.0001"  required>
									</td>
									<td>
										<input type="number" step="0.0001" class="form-control number" v-model.number="dato.descuentocantidad" v-on:keyup="phuyu_calcular(dato,3)" min="0.01"  required>
									</td>
									<td>
										<input type="number" step="0.0001" class="form-control number" v-model.number="dato.cantidad" v-on:keyup="phuyu_calcular(dato,3)" min="0.0001"  required readonly>
									</td>
									<td> 
							...
							<tfoot>
								<tr>
									<td colspan="7" align="right"><b>Total Ingreso S/.</b></td>
					...
					<div class="row form-group">
						...
						<div class="col-md-9" align="right">
							<button type="submit" class="btn btn-primary btn-icon" v-bind:disabled="estado==1"> <b>GUARDAR INGRESO</b> </button>
