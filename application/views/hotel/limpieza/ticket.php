...
<head>
	<meta charset="utf-8">
	<title>Orden de limpieza OL-<?php echo $esc($orden["numero_orden"]); ?></title>
	<style>
		...
		*{box-sizing:border-box}
		...
		h1{font-size:17px;text-align:center;margin:0 0 4px;font-weight:800}
...
<body onload="window.print()">
	<div class="ticket">
		<h1>ORDEN DE LIMPIEZA</h1>
		<div class="sub">OL-<?php echo $esc($orden["numero_orden"]); ?></div>
		...
		<div class="row"><div class="label">Fecha/hora</div><div class="value"><?php echo $esc($orden["fecha"]." ".$orden["hora"]); ?></div></div>
		<div class="row"><div class="label">Usuario</div><div class="value"><?php echo $esc($orden["usuario"]); ?></div></div>
		<div class="row"><div class="label">Responsable</div><div class="value"><?php echo $esc($orden["responsable"]); ?></div></div>
		<div class="row"><div class="label">Tipo</div><div class="value"><?php echo $esc($orden["tipo_limpieza_texto"]); ?></div></div>
		<div class="block">
			<div class="label">Checklist</div>
			<ul>
				<?php foreach ($orden["checklist_items"] as $item): ?>
