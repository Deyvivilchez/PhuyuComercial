	...
	public function index(){
		if ($this->input->is_ajax_request()) {
			if (isset($_SESSION["phuyu_codusuario"])) {
				...
				$this->load->view("compras/compras/nuevacompra",compact("comprobantes","conceptos","tipopagos","monedas","centrocostos"));
			}else{
	...
	function guardar(){
		if ($this->input->is_ajax_request()) {
			...
			if (isset( $_SESSION["phuyu_codusuario"]) ) {
				...
				$detalle = $this->Kardex_model->phuyu_kardexdetalle($codkardex, $codkardexalmacen, $this->request->detalle, $retirar, 1);
