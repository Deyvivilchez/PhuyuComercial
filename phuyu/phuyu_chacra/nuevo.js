var phuyu_operacion = new Vue({
	...
	data: {
		estado:0,
		campos:{
			codlote:0, codsocio:1,codsocioreferencia:1, fechainicio:"", fechafin:"", departamento:"", observaciones:"", cliente:$("#empresa").val(), direccion:"",
	...
	methods: {
		...
		phuyu_editar: function(){
			this.$http.post(url+phuyu_controller+"/editar",{"codregistro":phuyu_lineas.registro}).then(function(info){
				...
				this.campos.codsocioreferencia = socio[0]["garante"];
