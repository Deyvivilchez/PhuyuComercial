var phuyu_lineas = new Vue({
	...
	methods: {
		...
		phuyu_asignargasto: function(){
			...
			if (this.registro==0) {
				phuyu_sistema.phuyu_alerta("DEBE SELECCIONAR UN REGISTRO", "PARA REGISTRAR UN NUEVO GASTO !!!","error");
			}else{
				phuyu_sistema.phuyu_inicio();
				this.$http.get(url+phuyu_controller+"/asignargasto/1/"+this.registro).then(function(data){
		...
		phuyu_salidaproductos:function(){
			phuyu_sistema.phuyu_inicio();
			this.$http.post(url+phuyu_controller+"/nuevasalida").then(function(data){
				$("#phuyu_sistema").empty().html(data.body);
			},function(){
				phuyu_sistema.phuyu_alerta("ESTAMOS TENIENDO PROBLEMAS LO SENTIMOS", "ERROR DE RED","error"); 
				phuyu_sistema.phuyu_fin();
		...
		phuyu_ingresoproductos:function(){
			phuyu_sistema.phuyu_inicio();
			this.$http.post(url+phuyu_controller+"/nuevoingreso").then(function(data){
				$("#phuyu_sistema").empty().html(data.body);
			},function(){
				phuyu_sistema.phuyu_alerta("ESTAMOS TENIENDO PROBLEMAS LO SENTIMOS", "ERROR DE RED","error"); 
				phuyu_sistema.phuyu_fin();
		...
		phuyu_historial: function(){
			if (this.registro==0) {
				phuyu_sistema.phuyu_alerta("DEBE SELECCIONAR UN REGISTRO", "PARA VER LOS MOVIMIENTOS EN EL SISTEMA !!!","error");
			}else{
				phuyu_sistema.phuyu_inicio();
