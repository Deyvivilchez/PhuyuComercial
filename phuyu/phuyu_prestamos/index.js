var phuyu_datos = new Vue({
	...
	methods: {
		...
		phuyu_operacion: function(tipo){
			if (this.registro==0) {
				phuyu_sistema.phuyu_alerta("DEBE SELECCIONAR UN PRESTAMO","SELECCIONAR CON UN CHECK","error");
			}else{
				if(tipo==this.operacion){
					...
					if (tipo==7) {
						phuyu_sistema.phuyu_alerta("DEBE SELECCIONAR UN PRESTAMO POR DEVOLVER","PARA REALIZAR LA RESPECTIVA DEVOLUCION","error");
					}else{
						phuyu_sistema.phuyu_alerta("DEBE SELECCIONAR UN PRESTAMO POR RECIBIR","PARA REALIZAR EL RECIBIMIENTO RESPECTIVO","error");
					}
				}
			}
		},
		...
		phuyu_historial: function(){
			if (this.registro==0) {
				phuyu_sistema.phuyu_alerta("DEBE SELECCIONAR UN REGISTRO", "PARA VER LOS PRESTAMOS DEL SOCIO EN EL SISTEMA !!!","error");
			}else{
				phuyu_sistema.phuyu_inicio();
