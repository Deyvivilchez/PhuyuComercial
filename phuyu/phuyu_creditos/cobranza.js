var phuyu_cobranza = new Vue({
	...
	data: {
		campos: {
			"codpersona": phuyu_creditos.registro,
			"codlote": phuyu_creditos.codlote,
			"codmoneda": 1,
			"tipocambio": 0.00,
			"codconcepto": 19,
			"rubro": $("#rubro").val(),
			...
			"importe": 0,
			"vuelto": 0,
			"fechadocbanco": $("#fechadocbanco").val(),
			"nrodocbanco": "",
			"total": 0,
			"descripcion": "COBRO DE CUOTAS",
			"fechamovimiento": $("#fechamovimiento").val(),
			"codctacte": 0,
			"cobrado": phuyu_creditos.cobrado
		},
	...
	methods: {
		...
		phuyu_guardar: function () {
			...
			this.estado = 1; 
			phuyu_sistema.phuyu_inicio_guardar("GUARDANDO COBRO DEL CREDITO . . .");
	...
	created: function () {
		...
		console.log("COBRADO :", this.campos.cobrado);
	}
});