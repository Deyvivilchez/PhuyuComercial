var phuyu_datos = new Vue({
	...
	methods: {
		...
		phuyu_imprimircronograma: function (codcredito) {
			if (!codcredito || codcredito == 0) {
				phuyu_sistema.phuyu_alerta("NO SE ENCONTRO EL CREDITO", "ERROR", "error");
				return;
			}
			window.open(url + phuyu_controller + "/phuyu_imprimircronograma/" + codcredito, "_blank");
		},
	},
	created: function () {
		this.phuyu_datos();
