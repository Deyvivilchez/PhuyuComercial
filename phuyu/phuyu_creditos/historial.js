var phuyu_historial = new Vue({
	...
	data: {
		...
		campos:{"codpersona":0,"codlote":0,"fechadesde":"","fechahasta":"","estado":1,"filtro":1,"tipo":$("#tipo").val()},
	},
	methods: {
		phuyu_fechas: function(){
			this.campos.codpersona = phuyu_creditos.registro;
			this.campos.codlote = phuyu_creditos.codlote;
