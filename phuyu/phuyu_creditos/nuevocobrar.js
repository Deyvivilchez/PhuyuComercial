var phuyu_nuevocredito = new Vue({
	...
	data: { "rubro":$("#rubro").val(), "importetotalcredito":0,"importecredito":0,"interescredito":0,
		campos:{
			"codregistro":"","codpersona":phuyu_creditos.registro,"codempleado":0,"codlote":phuyu_creditos.codlote,"nrotarjeta":"","fechacredito":$("#fecha").val(),"fechainicio":$("#fecha").val(),
	...
	methods: {
		...
		phuyu_guardar: function(){
			...
			if(this.campos.codlote==0 && this.rubro==6){
				phuyu_sistema.phuyu_noti("ATENCION USUARIO: EL CREDITO NO SE PUEDE REALIZAR PORQUE EL CLIENTE SELECCIONADO NO CUENTA CON UNA LINEA DE CREDITO VÁLIDA","","error");
				return false;
			}
