   ...
   var tipo = 0;
    ...
    jQuery('#codpersona').select2({
      ...
      templateSelection: function formatResultSelection(result) {
        ...
        if(typeof result.razonsocial != "undefined" && phuyu_movimiento.campos.codpersona!= result.codpersona && phuyu_controller != 'compras/compras'){
            phuyu_movimiento.phuyu_infocliente();
        }
        if(typeof result.razonsocial == "undefined"){
          result.razonsocial = phuyu_movimiento.campos.cliente;
        }
        //
