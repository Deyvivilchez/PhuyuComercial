var phuyu_form = new Vue({
	...
	methods: {
		...
		phuyu_controlarseries() {
			// Lógica para activar/desactivar control de series
			this.campos.controlarseries = this.campos.controlarseries == 1 ? 0 : 1;
		...
		phuyu_guardar: function () {
			...
			// 	this.campos.controlarseries = 0;
			// if ($("#controlarseries").is(":checked")) {
			// 	this.campos.controlarseries = 1;
			// }
